...
mod tests {
    ...
    async fn refresh_dates() {
        ...
        let invoice1_result = InvoiceRepository::new(&connection)
        ...
        let invoice2_result = InvoiceRepository::new(&connection)
    ...
    async fn all_fields_are_present() {
        let (_, connection, _, _) =
            crate::test_db::setup_all("all_fields_are_present_timestamps", MockDataInserts::none())
                .await;
